...
<div class="row">
    ...
    <div class="col-md-9 col-sm-7">
            ...
            <ul class="nav nav-tabs" role="tablist" id="demandTabs">
                <li role="presentation" class="active"><a href="#all" aria-controls="all" role="tab" data-toggle="tab">所有报名需求</a></li>
                <li role="presentation"><a href="#rough" aria-controls="rough" role="tab" data-toggle="tab">报名中</a></li>
                <li role="presentation"><a href="#publish" aria-controls="publish" role="tab" data-toggle="tab">报名成功</a></li>
                <li role="presentation"><a href="#complete" aria-controls="complete" role="tab" data-toggle="tab">报名失败</a></li>
            </ul>
...
<script src="${pageContext.request.contextPath}/static/js/myApply.js"></script>
</body>
    </html>
